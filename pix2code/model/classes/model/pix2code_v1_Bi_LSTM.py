...
class pix2code_v1_Bi_LSTM(AModel):
    def __init__(self, input_shape, output_size, output_path):
        AModel.__init__(self, input_shape, output_size, output_path)
        self.name = "pix2code_v1_Bi_LSTM"
        ...
        language_model.add(Bidirectional(LSTM(512, return_sequences=True, input_shape=(CONTEXT_LENGTH, output_size))))
        language_model.add(Bidirectional(LSTM(512, return_sequences=True)))
